page 50205 "APIV2 - Contacts DDG"
{
    ...
    begin
        if contact."Contact Business Relation" <> contact."Contact Business Relation"::Customer then
            exit;
        ContBusRel.FindByContact(LinkType::Customer, contact."Company No.");
        exit(ContBusRel."No.");
    end;
